...
%Paraphrase and add this sentence somewhere:
%Once a (possibly over-complete) list of UT integrals has been found, their definitions
%can be added as additional equations to the IBP system. By assigning a lower weight to these
%integrals, they will be automatically chosen as preferred master integrals by the system solver
