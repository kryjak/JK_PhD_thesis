...
\begin{equation}
    ...
    \end{cases}
\end{equation}  
%Insert references to GPLs.
%What happens if the kernels are not rational --> elliptic functions.
%Maximal cuts to analyse DEs
