...
\end{equation}
While the special functions $\{f_i\}$ that come from the MIs are complicated functions with poles and branch cuts, the coefficients $r_i$ are rational functions that are computed and reconstructed from finite fields. We remind the reader that they will be usually expressed in terms of the momentum twistors $\mathbf{x}$. 
