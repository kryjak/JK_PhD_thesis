...
\end{align}
Here, $\dd$ is the total differential, $\dd f \coloneqq \dd s_{12} \, \partial_{s_{12}} f + \dd s_{23} \, \partial_{s_{23}} f +  \dd s_{4} \, \partial_{s_{4}} f $, $A^{(T)}_i$ are constant $n_{T} \times n_{T}$ matrices, with $n_{T}$ the number of MIs of the family $T$, and: 
\begin{align}
