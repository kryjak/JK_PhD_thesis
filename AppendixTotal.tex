...
In this section, we discuss how we can incorporate the IBP reduction in our workflow in a more efficient way. We will use this method when computing the amplitudes presented in Chapter~\ref{sec:QEDpaper}.
