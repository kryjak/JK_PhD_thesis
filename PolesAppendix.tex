...
\begin{align}
    ...
    \bm{I}^{(2)}(\eps) &= \frac{\mathrm{e}^{-\eps \gamma_E} \Gamma(1-2\eps)}{\Gamma(1-\eps} \left( \frac{\gamma_1^\text{cusp}}{8} + \frac{\beta_0}{2\eps} \right) \bm{I}^{(1)}(2\eps) - \frac{1}{2}\bm{I}^{(1)}(\eps) \left(\bm{I}^{(1)}(2\eps) + \frac{\beta_0}{\eps} \right) + \bm{H}_{\text{RS}}^{(2)}(\eps)\,,
\end{align}
...
\begin{align}
    ...
    &+ \frac{\ii f^{abc}}{24\eps} \sum_{(i,j,k)} \bm{T}_i^a \bm{T}_j^b \bm{T}_k^c \ln\left(\frac{-s_{ij}}{-s_{jk}} \right) \ln\left(\frac{-s_{jk}}{-s_{kj}} \right) \ln\left(\frac{-s_{ki}}{-s_{ij}} \right) \\
